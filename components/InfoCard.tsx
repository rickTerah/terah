export default function InfoCard() {
  return (
    <div className="flex-1 ">
      <div className="mb-8">
        <h1 className="mb-4 font-bold text-gruvbox-light-fg dark:text-gruvbox-dark-fg text-xl">
          {"> Hello World! ✋"}
        </h1>
        <h1 className=" font-bold text-gruvbox-light-fg dark:text-gruvbox-dark-fg text-2xl">
          {"Patrick Mwangi"}
        </h1>
      ...
      <div className="mb-8">
        ...
        <p className=" text-gruvbox-light-fg dark:text-gruvbox-dark-fg text-md">
          Art, Music, Mathematics, Nature, Hiking, Travelling and Technology.
        </p>
      </div>
    </div>
  );
